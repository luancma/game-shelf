...
var CreateSessionService = /** @class */ (function () {
    function CreateSessionService(usersRepository) {
        this.usersRepository = usersRepository;
    }
    CreateSessionService.prototype.execute = function (_a) {
        var email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user, validatePassword, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.getUser({ email: email })];
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new Error('Email ou senha inválidos');
                        }
                        validatePassword = bcryptjs_1.compare(password, user.password);
                        if (!validatePassword) {
                            throw new Error('Email ou senha inválidos');
                        }
